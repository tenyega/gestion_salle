 ...
 */
final class Version20241015101243 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE hall (id INT AUTO_INCREMENT NOT NULL, event_type_id_id INT NOT NULL, addresse_id_id INT NOT NULL, name VARCHAR(255) NOT NULL, area VARCHAR(120) NOT NULL, accessibility VARCHAR(255) NOT NULL, capacity_max INT NOT NULL, price_per_hour NUMERIC(5, 2) NOT NULL, opening_time TIME NOT NULL, closing_time TIME NOT NULL, UNIQUE INDEX UNIQ_1B8FA83F29A6C08F (event_type_id_id), UNIQUE INDEX UNIQ_1B8FA83FC2360D68 (addresse_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE hall_equipment (hall_id INT NOT NULL, equipment_id INT NOT NULL, INDEX IDX_B7E2D29D52AFCFD6 (hall_id), INDEX IDX_B7E2D29D517FE9FE (equipment_id), PRIMARY KEY(hall_id, equipment_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE hall_equipment ADD CONSTRAINT FK_B7E2D29D52AFCFD6 FOREIGN KEY (hall_id) REFERENCES hall (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE hall_equipment ADD CONSTRAINT FK_B7E2D29D517FE9FE FOREIGN KEY (equipment_id) REFERENCES equipment (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hall_equipment DROP FOREIGN KEY FK_B7E2D29D52AFCFD6');
        $this->addSql('ALTER TABLE hall_equipment DROP FOREIGN KEY FK_B7E2D29D517FE9FE');
